...
public abstract class BrentSolver implements LineSearchable{
    ...
    public double getFunctionAccuracy() { return functionAccuracy;}
    ...
    public double computeObjectiveValue(double z) {
    	...
    	System.out.println("evaluated scalar loc: "+z+" at x[0]" + xrev[0] + " x[1] " + xrev[1]+" gives xout: " +xout);
    ...
    public double doSolve() {
        ...
        System.out.println("ok initial " + initial +
    			" min " + min + " yInitial " + yInitial + " ymin " + yMin);  
    	
        // Reduce interval if min and initial bracket the root.
        if (yInitial * yMin < 0) {
        	System.out.println("A initial " + initial +
        			" min " + min + "yInit" + yInitial + " " + yMin);
        ...
        if (yInitial * yMax < 0) {
        	System.out.println("B initial " + initial +
        			" max " + max + "yInit" + yInitial + " " + yMax);
