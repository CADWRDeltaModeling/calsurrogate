...
/** Base interface for converting daily input into any specialty time averages or groupings are expected by a surrogate. 
 * This step is fairly tightly associated with the surrogate architecture.
 */
public interface DailyToSurrogate {
	
	
	/**
	 * Take daily inputs and create the actual values used in the surrogate such as ANN.Bas
