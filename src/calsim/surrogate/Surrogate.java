...
public interface Surrogate extends DailyToSurrogate {
	...
	/**
	 * Converts a forward-in-time time history with day of forecast at currentIndex into
	 * whatever vector of aggregated history (blocks of averages, convolutions, etc) used by the surrogate
	 * @param dailyData
	 * @param currentIndex
	 * @return
	 */
