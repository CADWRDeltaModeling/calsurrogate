...
/**
 * Utility to explore contours of a multi-input ANN to probe a set of contours.
 * Not ready for uses
 */
public class TensorContourExplore extends BrentSolver {
	...
	// double xLoc = 0.; // Sets xLoc, which is the position of the variable being
	// explored at fixed intervals
	...
	public TensorContourExplore(Surrogate tWrap, ArrayList<double[][]> paramsFloat, ArrayList<long[][]> paramsInt,
			int feature0, int ndx0, int feature1, int ndx1) {
